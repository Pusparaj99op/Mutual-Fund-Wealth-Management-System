...
# API Documentation
API Docs: https://www.mfapi.in/docs/#/Search

Mutual Fund API: API for accessing mutual fund data including NAV history, scheme information, and search functionality, Simple REST API with JSON responses. Works with any programming language, No authentication, no API keys, no rate limiting. Just pure data access.
...
Schemes
Operations related to mutual fund schemes listing

GET
/mf
List all mutual fund schemes

NAV Data
Operations for retrieving NAV (Net Asset Value) data
